...
public interface DonHangRepository extends JpaRepository<DonHang, Long> {
    ...
    @Query(value = "select dh.id, dh.ten_sp , dh.so_luong , dh.so_tien , dh.so_tien_dang_thieu , dh.trang_thai , nd.dia_chi , nd.xa_phuong , nd.quan_huyen , dh.link, nd.tinh_thanh, dh.ngay_mua, dh.nguoi_dung_id, nd.ho_ten, nd.sdt from don_hang dh join nguoi_dung nd on dh.nguoi_dung_id = nd.id where dh.trang_thai = 'Đang chờ lấy hàng'", nativeQuery = true)
